-- ============================================================
-- RentFlow Phase 3: Multi-Tenant Schema Migration
-- ============================================================

-- 1. Update users table: add company_id, change role to VARCHAR
ALTER TABLE users
  ADD COLUMN company_id INT UNSIGNED DEFAULT NULL AFTER id,
  MODIFY COLUMN role VARCHAR(20) NOT NULL DEFAULT 'TENANT',
